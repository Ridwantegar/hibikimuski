module.exports = {
  TOKEN: process.env.TOKEN || "MTEzOTg4Nzc2Mzc2OTAwMDAwNg.G8FsJC.IEgPBe6Prfhb5thfEZOMPjRpZvnRr3MZ2XZXFU",
  PREFIX: process.env.PREFIX || "h!",
  embed: {
  ...
  // others
  mongodb: process.env.MONGO_URL || "mongodb+srv://CodeXDev:CodeX007@codex-public.lo930xf.mongodb.net/?retryWrites=true&w=majority",
  filters: {
